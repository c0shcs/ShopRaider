...
public class ArtikelPanel extends JPanel {
	...
	public ArtikelPanel() {
		...
		setLayout(null);
		setBounds(100, 100, 904, 215);
		
		JPanel panArtikel = new JPanel();
		panArtikel.setBounds(5, 5, 894, 205);
		add(panArtikel);
		...
		lblArtBild.setBounds(5, 5, 195, 195);
